...
<style>
    ...
    <div class="rightcon">
    	<div class="right_con">
        	...
        	<table id="tab">
                <tr>
                    <th class="thead">用户名</th>
                    <th class="thead">用户id</th>
                    <th class="thead">角色</th>
                    <th class="thead">编辑</th>
                </tr>  
                <?php foreach($list as $k=>$v){?>
                <tr>
                    <td class="thead"><?php echo $v['user_name'];?></td>
                    <td class="thead"><?php echo $v['user_id'];?></td>
                    <td class="thead"><?php echo $v['role_name'];?></td>
                    <td class="thead"><a href="">修改</a></td>
                </tr> 
                <?php }?>
            </table>
