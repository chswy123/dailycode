...
<style>
    ...
    <div class="rightcon">
        ...
        <p style="text-align:center">请选择语言
            <select name="codename" id="codetype">
            ...
            <textarea name="" id="codearea1" cols="30" rows="10"></textarea>
            <input type="button" value="执行" onclick="get_code_text()">
            <span id="tag">====></span>
            <textarea name="" id="codearea2" cols="30" rows="10"></textarea>
...
<script type="text/javascript">
	function get_code_text(){
        // alert(11);
        var codetext = $("#codearea1").val();
        var codetype = $("#codetype").val();
        $.post('<?php echo U("Codeonline/getCode");?>',{code:codetext,type:codetype},function(data){
            // alert(data);
            var jsondemo = eval('('+data+')');
            // var code = jsondemo.result;
            console.log(data);
            // console.log(<?php eval($result);?>);
        });
    }
</script>